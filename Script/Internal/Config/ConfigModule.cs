...
namespace XD.SDK.Common.PC.Internal {
    internal class ConfigModule {
        ...
        internal static void LoadConfig() {
            ...
            if (string.IsNullOrEmpty(appConfig.WebPayUrl))
            {
                appConfig.WebPayUrl = appConfig.IsGlobal ? "https://sdkpay.xd.com" : "https://sdkpay.xd.cn";
            }

            if (string.IsNullOrEmpty(appConfig.WebPayUrlForPC))
            {
                appConfig.WebPayUrlForPC = appConfig.IsGlobal ? "https://sdkpay.xd.com" : "https://sdkpay.xd.cn";
            }

            if (string.IsNullOrEmpty(appConfig.CancelUrl))
            {
                appConfig.CancelUrl = appConfig.IsGlobal ? "https://logout-xdsdk.xd.com" : "https://logout-xdsdk.xd.cn";
            }
        }
