...
{
    public class XDMainlandGenerateGradleAdapter : IPostGenerateGradleAndroidProject
    {
        private const string UnityLibraryName = "unityLibrary";
        private const string MatchText = "mavenCentral()";
        private const string Repo = "maven { url 'https://artifact.bytedance.com/repository/AwemeOpenSDK' }";
