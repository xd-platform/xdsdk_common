...
namespace XD.SDK.Share
{
    public class XDShareMobile : IXDShare
    {
        ...
        public static void ShareImage(ShareConstants.ShareTarget target, ShareConstants.ShareScene scene, byte[] imageData, IXDShareCallback callback){
            XDShareMobileImpl.GetInstance().ShareImage(target, scene, imageData, callback);
        }
        ...
        void IXDShare.ShareImage(ShareConstants.ShareTarget target, ShareConstants.ShareScene scene, byte[] imageData, IXDShareCallback callback){
            ShareImage(target, scene, imageData, callback);
        }
