...
+ (BOOL)isTargetInstalled:(XDShareTarget)target;

+ (void)shareWithTarget:(XDShareTarget)type sceneType:(XDShareSceneType)sceneType text:(NSString *)text completeHandler:(XDShareResultHandler)completeHandler;

+ (void)shareWithTarget:(XDShareTarget)type sceneType:(XDShareSceneType)sceneType imageUri:(NSString *)imageUri completeHandler:(XDShareResultHandler)completeHandler;

+ (void)shareWithTarget:(XDShareTarget)type sceneType:(XDShareSceneType)sceneType imageData:(NSData *)imageData completeHandler:(XDShareResultHandler)completeHandler;

+ (void)shareWithTarget:(XDShareTarget)type sceneType:(XDShareSceneType)sceneType webPage:(XDShareWebPage *)webPage completeHandler:(XDShareResultHandler)completeHandler;
