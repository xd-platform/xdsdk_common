...
+ (void)reportWithServerId:(NSString *)serverId roleId:(NSString *)roleId roleName:(NSString *)roleName DEPRECATED_MSG_ATTRIBUTE("Please use TapSupportSDK instead");
...
+ (void)setCurrentUserDayPushServiceEnable:(BOOL)enable;

+ (BOOL)isCurrentUserDayPushServiceEnable;

+ (void)setCurrentUserNightPushServiceEnable:(BOOL)enable;

+ (BOOL)isCurrentUserNightPushServiceEnable;
...
+ (void)application:(UIApplication *)application openURL:(NSURL *)url options:(NSDictionary<UIApplicationOpenURLOptionsKey,id> *_Nullable)options;
