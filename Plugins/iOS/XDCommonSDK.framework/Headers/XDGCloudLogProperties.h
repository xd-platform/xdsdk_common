...
extern NSString *const XDGCloudLogProperties_TAPDB_ID;
extern NSString *const XDGCloudLogProperties_APPSFLYER_UID;
extern NSString *const XDGCloudLogProperties_FIREBASE_ID;
extern NSString *const XDGCloudLogProperties_GAME_FIRST_OPEN_TIME;
