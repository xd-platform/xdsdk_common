...
FOUNDATION_EXPORT TDSGlobalRouterScheme TDSGLOBAL_INIT_SUCCESS;
...
FOUNDATION_EXPORT TDSGlobalRouterScheme TDSGLOBAL_SHARE_IMAGE_DATA;
FOUNDATION_EXPORT TDSGlobalRouterScheme TDSGLOBAL_SHARE_URL;

FOUNDATION_EXPORT TDSGlobalRouterScheme TDSGLOBAL_SHARE_TEXT_CN;
FOUNDATION_EXPORT TDSGlobalRouterScheme TDSGLOBAL_SHARE_IMAGE_PATH_CN;
FOUNDATION_EXPORT TDSGlobalRouterScheme TDSGLOBAL_SHARE_IMAGE_DATA_CN;
FOUNDATION_EXPORT TDSGlobalRouterScheme TDSGLOBAL_SHARE_URL_CN;

/** 国内三方库事件 */
FOUNDATION_EXPORT TDSGlobalRouterScheme TDSGLOBAL_THIRD_CN_INIT_SCHEME;
FOUNDATION_EXPORT TDSGlobalRouterScheme TDSGLOBAL_THIRD_CN_OPEN_URL_SCHEME;
FOUNDATION_EXPORT TDSGlobalRouterScheme TDSGLOBAL_THIRD_CN_CONTINUE_USER_ACTIVITY_SCHEME;
